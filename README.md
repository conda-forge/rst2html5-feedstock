...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rst2html5-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13502&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rst2html5-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rst2html5` can be installed with:

```
conda install rst2html5
```

It is possible to list all of the versions of `rst2html5` available on your platform with:
